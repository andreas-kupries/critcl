...
test critcl-ccommand${suffix}-1.0.6 {ccommand, wrong\#args} -constraints tcl86plus -body {
    critcl::ccommand
} -returnCodes error -result {wrong # args: should be "critcl::ccommand name anames ?arg ...?"}

test critcl-ccommand${suffix}-1.0.5 {ccommand, wrong\#args} -constraints tcl85 -body {
    critcl::ccommand
} -returnCodes error -result {wrong # args: should be "critcl::ccommand name anames ..."}

test critcl-ccommand${suffix}-1.0.4 {ccommand, wrong\#args} -constraints tcl84 -body {
    critcl::ccommand
...
test critcl-ccommand${suffix}-3.0 {ccommand, defaults} -setup setup -body {
    ...
    -result [viewFile [localPath test/support/ccommand${suffix}/3.0]]
...
test critcl-ccommand${suffix}-3.4 {ccommand, -delproc} -setup setup -body {
    ...
    -result [viewFile [localPath test/support/ccommand${suffix}/3.4]]
...
test critcl-ccommand${suffix}-3.5 {ccommand, -clientdata} -setup setup -body {
    ...
    -result [viewFile [localPath test/support/ccommand${suffix}/3.5]]
