...
void critcl_trace_on         (int on);
void critcl_trace_off        (int on);
void critcl_trace_enter      (int on, const char* function_name);
void critcl_trace_return     (int on, const char *pat, ...);
void critcl_trace_printf     (int on, int indent, const char *pat, ...);
...
#define TRACE_ENTER(fun)       critcl_trace_enter  (__critcl_tag___THIS_FILE_status, fun)
...
#define TRACE0(format, ...)    critcl_trace_printf (__critcl_tag___THIS_FILE_status, 0, format, __VA_ARGS__)
#define TRACE(format, ...)     critcl_trace_printf (__critcl_tag___THIS_FILE_status, 1, format, __VA_ARGS__)

#define TRACE_TAG_ENTER(t,fun)       critcl_trace_enter   (__critcl_tag_ ## t ## _status, fun)
...
#define TRACE0_TAG(t,format, ...)    critcl_trace_printf0 (__critcl_tag_ ## t ## _status, 0, format, __VA_ARGS__)
#define TRACE_TAG(t,format, ...)     critcl_trace_printf  (__critcl_tag_ ## t ## _status, 1, format, __VA_ARGS__)

#define TRACE_CPROC_ARGS(f,c,v) {		\
	critcl_trace_enter (1,f);	\
